...
class DataProcessor {
     ...
     */
    parseGeoJSONData(buffer) {
        var _a;
        try {
            const jsonString = buffer.toString('utf8');
            const geoData = JSON.parse(jsonString);
            console.log(`Parsed GeoJSON with ${((_a = geoData.features) === null || _a === void 0 ? void 0 : _a.length) || 0} features`);
            return geoData;
        }
        catch (error) {
     ...
     */
    async extractDataPoints(dataset, datasetId) {
        try {
            ...
            if (dataset.fileType === 'csv') {
                ...
                const latHeader = Object.keys(csvData[0]).find(h => ['lat', 'latitude', 'y'].includes(h.toLowerCase()));
                const lngHeader = Object.keys(csvData[0]).find(h => ['lng', 'lon', 'longitude', 'x'].includes(h.toLowerCase()));
                    ...
                    dataPoints = geoData.features
                        ...
                        if (feature.geometry && feature.geometry.coordinates) {
                            ...
                            return {
                                ...
                                lat: parseFloat(lat),
                                lng: parseFloat(lng),
                                value: parseFloat(((_a = feature.properties) === null || _a === void 0 ? void 0 : _a.value) || ((_b = feature.properties) === null || _b === void 0 ? void 0 : _b.score) || '0') || Math.random() * 100,
                                bias: parseFloat(((_c = feature.properties) === null || _c === void 0 ? void 0 : _c.bias) || '0') || Math.random(),
                                category: ((_d = feature.properties) === null || _d === void 0 ? void 0 : _d.category) || ((_e = feature.properties) === null || _e === void 0 ? void 0 : _e.type) || 'unknown',
     ...
     */
    async performComprehensiveAnalysis(dataPoints, dataset) {
        try {
            ...
            // Basic statistics
            const validCoordinates = dataPoints.filter(p => p.lat !== null && p.lng !== null &&
                !isNaN(p.lat) && !isNaN(p.lng)).length;
     ...
     */
    analyzeCategoryDistribution(dataPoints) {
        const categoryCount = {};
     ...
     */
    analyzeSpatialDistribution(dataPoints) {
        if (dataPoints.length === 0) {
